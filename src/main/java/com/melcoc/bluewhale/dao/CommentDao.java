...
public interface CommentDao extends BaseMapper<Comment> {
    ...
    @Select("select t1.*,t2.name,t2.nick_name from comment t1 LEFT JOIN  user t2   ON t1.user_id =t2.user_id WHERE t1.answer_id=#{answerId} and t1.deleted=0  order by t1.comment_id desc limit 1")
